        ...
        <div class="box">
            ...
            <div class="box-body table-responsive">
                <div class="box-body pad form-group">
                    ...
                    <form>
                        <textarea class="form-control" id="content" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 16px; line-height: 12px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                    </form>
                </div>
                <div class="box-body pad form-group">
